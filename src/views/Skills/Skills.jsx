...
export default function Skills() {
  ...
  return (
    <div className="flex flex-col items-center m-8 md:px-0">
      <ul className="flex flex-row menu bg-gray-800 text-gray-300 text-xl rounded-xl w">
        <li className="menu-title text-gray-400 text-xl">Filter By:</li>
        <li>
          <button onClick={() => handleToggleCategory("professional")}>
            Skill Set
          </button>
        </li>
        <li>
          <button onClick={() => handleToggleCategory("tools")}>Tools</button>
        </li>
        <li>
          <button onClick={() => handleToggleCategory("softSkills")}>
            Soft Skills
          </button>
        </li>
        <li>
