    ...
    <div className='flex flex-col items-center my-8 px-4'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-screen-xl'>
        ...
        <ProjectCard
          ...
          linkForSite='https://task-manager-five-kohl.vercel.app/'
          image={taskManager}
        />
        <ProjectCard
        ...
        <ProjectCard
          ...
          linkForSite='https://portfolio-example-beige-six.vercel.app/'
          image={myPortfolio}
        />
        <ProjectCard
        ...
        <ProjectCard
          ...
          linkForSite='https://investment-calculator-seven-nu.vercel.app/'
        ...
        <ProjectCard
          ...
          linkForSite='https://traffic-watch.vercel.app/'
          image={traffic}
        />
      </div>
    </div>
